...
export const SHAPES = {
  ...
  INDICATORS: {
    ...
    attributeGroups: {
      schedule: {
        message: 'entities.due_dates.schedule',
        icon: 'reminder',
      },
    },
    fields: [
      ...
      },
      {
        ...
        column: 'aside',
        group: 'schedule',
        required: (attributes) => attributes.get('repeat'),
        validate: (attributes) => ({
          before: attributes.get('end_date'),
        }),
      },
      {
        attribute: 'repeat',
        ...
        column: 'aside',
        group: 'schedule',
        validateFields: ['start_date', 'end_date'],
      },
      // {
      //   attribute: 'frequency_months',
      //   // control: 'status',
      //   // type: 'bool',
      //   default: REPORT_FREQUENCIES[0] ? REPORT_FREQUENCIES[0].value : '',
      //   section: 'body',
      //   column: 'aside',
      //   hidden: (attributes) => !attributes.get('repeat'),
      // },
      {
        attribute: 'end_date',
        control: 'date',
